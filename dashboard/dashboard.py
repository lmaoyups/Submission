...
def plot_top_10_products():
    # Data 1
    orders_df = pd.read_csv(r"C:\Users\devina\Documents\Submission\data\orders_dataset.csv")
    order_items_df = pd.read_csv(r"C:\Users\devina\Documents\Submission\data\order_items_dataset.csv")
    products_df = pd.read_csv(r"C:\Users\devina\Documents\Submission\data\products_dataset.csv")
...
def plot_top_10_cities():
    # Data 2
    customers_df = pd.read_csv(r"C:\Users\devina\Documents\Submission\data\customers_dataset.csv")
...
def plot_top_10_sellers():
    # Data 4
    product_orders = pd.read_csv(r"C:\Users\devina\Documents\Submission\data\order_items_dataset.csv")
    sellers_df = pd.read_csv(r"C:\Users\devina\Documents\Submission\data\sellers_dataset.csv")
